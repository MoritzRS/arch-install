...
pacman -S rofi rxvt-unicode polybar dunst ristretto maim xdotool xdg-utils lxrandr-gtk3 lxappearance papirus-icon-theme xfce4-power-manager nitrogen git unzip wget --needed --noconfirm
